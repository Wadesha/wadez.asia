...
仓库(warehouse)、配送中心(distribution)、站点(station)、港口(port)、机场(airport)、铁路枢纽(railway)、公路枢纽(highway)、其他(other)

### 功能清单

- 地图浏览：基于高德地图的物流 POI 展示，支持缩放、平移
